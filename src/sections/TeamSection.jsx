...
function TeamSection() {
  const teamMembers = [
    { 
      ...
      bio: 'Líder con una profunda experiencia en el espacio blockchain y DeFi, impulsando la visión y dirección estratégica de HighPower. Especializado en diseño de ecosistemas y crecimiento de comunidades.',
      avatar: 'https://placehold.co/150x150/8A2BE2/FFFFFF/png?text=VP'
    },
    { 
      ...
      avatar: 'https://placehold.co/150x150/4169E1/FFFFFF/png?text=AC'
    },
    { 
      ...
      avatar: 'https://placehold.co/150x150/00FF7F/000000/png?text=ME'
    },
    { 
      ...
      avatar: 'https://placehold.co/150x150/FFD700/000000/png?text=EC'
    },
    { 
      ...
      avatar: 'https://placehold.co/150x150/A020F0/FFFFFF/png?text=AT'
    },
    { 
      ...
      avatar: 'https://placehold.co/150x150/ADD8E6/000000/png?text=CD'
    },
  ];
    ...
    <section id="team" className="p-8 bg-[var(--dark-gray)] rounded-3xl shadow-xl space-y-6 text-center border-2 border-[var(--accent-yellow)]">
      ...
      <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {teamMembers.map((member, index) => (
          <div key={index} className="bg-gray-800 p-6 rounded-lg shadow-md border border-gray-700 flex flex-col items-center transform transition-transform duration-300 hover:scale-105 hover:border-[var(--accent-yellow)]">
            {/* Avatar */}
            <img 
              src={member.avatar} 
      ...
      <p className="mt-8 text-gray-500 text-sm">
        "En las fases iniciales, el equipo mantiene el anonimato para proteger el desarrollo, enfatizando el compromiso con la comunidad y la promesa de una transparencia creciente a medida que el proyecto evolucione."
      </p>
    </section>
  );
}
